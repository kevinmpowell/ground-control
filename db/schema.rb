...
ActiveRecord::Schema.define(version: 20150406210954) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "client_repos", force: :cascade do |t|
  ...
  create_table "github_syncs", force: :cascade do |t|
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "auth_token"
    t.boolean  "admin"
    t.datetime "last_github_sync_at"
  end
